...
export default function Card1() {
  ...
  <p className="text-gray-100 text-sm mb-6">
    Investock.ai is an AI-powered trading and investing platform designed for stock and crypto traders. 
    It brings advanced charting, real-time market data, strategy building, and backtesting into one place—helping traders save time, avoid costly mistakes, and make data-driven decisions with confidence.
  </p>
</div>
          ...
          {/* View project button */}
          <Link
            to="/investock/investock-app-design"
            className="
