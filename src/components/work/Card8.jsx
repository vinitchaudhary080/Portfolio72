...
export default function Card1() {
  ...
  const tags = ["Finance", "Mobile", "Subscriptions"];
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-[60%_40%]">
          ...
          <div className="relative p-5 sm:p-6 md:p-8 flex flex-col">
            ...
            <p className="mt-3 text-xs text-white/55">UX Flows • Mobile</p>
            ...
            <div className="mt-5">
              <Link
                to="/copartnerapp/copartner-finance-agency"
                className="
