...
// main hero (left)
import mainImage from "../../assets/ChartingHQ/project1.webp";

// thumbs (marquee)
import thumb1 from "../../assets/ChartingHQ/project1.webp";
import thumb2 from "../../assets/ChartingHQ/2.webp";
import thumb3 from "../../assets/ChartingHQ/3.webp";
import thumb4 from "../../assets/ChartingHQ/4.webp";
...
export default function Card1() {
  ...
  const tags = ["Fintech", "Analytics", "Web"]; // WorkSection-style pills
        ...
        <div className="grid grid-cols-1 md:grid-cols-[60%_40%]">
          ...
          <div className="relative p-5 sm:p-6 md:p-8 flex flex-col">
            ...
            <p className="text-white/75 text-sm sm:text-base leading-relaxed mt-3">
              Your all-in-one stock market dashboard, delivering real-time
