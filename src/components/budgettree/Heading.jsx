  ...
  return (
    <section className="bg-black text-white pt-24 pb-8 sm:py-12 px-4 sm:min-h-screen flex flex-col justify-center items-center text-center">
      ...
      <div className="w-full flex justify-between items-center text-xs sm:text-sm tracking-wide px-4 sm:px-20 mb-10">
        <span className="font-medium">Budgettre</span>
      ...
      <h1 className="text-4xl sm:text-6xl md:text-7xl font-light leading-tight max-w-5xl">
       – Budgettre – <br />
        Employee Gifting & Voucher Management App<br />
        <div className="mt-12">
         <h3 className="text-sm sm:text-lg font-normal mb-2">A modern platform that allows organizations to create, distribute, and manage digital gift vouchers for employees during festivals, special occasions, or reward programs.</h3>
