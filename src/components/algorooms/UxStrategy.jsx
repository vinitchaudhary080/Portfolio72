...
export default function VennUxStrategy() {
  ...
  // Trigger once when the section is mostly in view
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      (entries, obs) => {
        ...
        if (
          ...
          setState("row");   // animate to row a single time
  ...
  // headings visible before row; then center
      ...
      >
        ...
        >
          <div className="px-8 md:px-10 max-w-[420px] relative flex flex-col items-center justify-center">
            ...
            >
              <li>Provide traders with a one-stop platform for strategy creation, backtesting, and deployment.</li>
              <li>Increase stickiness through automation, reduce manual dependency.</li>
            </motion.ul>
          </div>
        </motion.div>
        ...
        >
          <div className="px-8 md:px-10 max-w-[420px] relative flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Traders missed entry/exit points due to manual tracking.</li>
              <li>No simple, no-code way to build trading strategies.</li>
              <li>Juggling between brokers, charts, and backtest tools wasted time.</li>
            </motion.ul>
          </div>
        </motion.div>
        ...
        >
          <div className="px-8 md:px-10 max-w-[440px] relative flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Broker API Integration (Zerodha, Upstox) for live order execution.</li>
              <li>Backtesting Engine connected to historical market data.</li>
              <li>Drag-and-drop strategy builder (rules, conditions, indicators).</li>
              <li>Scalable architecture to handle multiple concurrent strategies.</li>
            </motion.ul>
          </div>
        </motion.div>
      </div>
