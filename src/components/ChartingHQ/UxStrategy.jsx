...
export default function VennUxStrategy() {
  ...
  const playedOnceRef = useRef(false); // ensure animation runs only once

  // Run animation ONCE when ~55% of the section is visible
  useEffect(() => {
      ...
      <div className="relative hidden md:flex w-full max-w-7xl h-[760px] lg:h-[820px] items-center justify-center">
        ...
        >
          <div className="px-8 md:px-10 max-w-[420px] flex flex-col items-center justify-center">
            ...
            >
              <li>Consolidate charts, market overview, strategies, and deployment in one app.</li>
              <li>Reduce churn by saving traders’ time.</li>
            </motion.ul>
          </div>
        </motion.div>
        ...
        >
          <div className="px-8 md:px-10 max-w-[420px] flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Switching between TradingView, news, broker apps wasted time.</li>
              <li>No centralized hub for charting + execution.</li>
            </motion.ul>
          </div>
        </motion.div>
        ...
        >
          <div className="px-8 md:px-10 max-w-[440px] flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Advanced Charting Engine (TradingView libraries / ChartIQ).</li>
              <li>Market data feeds (Finnhub, NSE/BSE APIs).</li>
              <li>Insider strategy feature – prebuilt + custom templates.</li>
              <li>Backtesting framework using historical stock data.</li>
              <li>Broker connectivity for live deployment.</li>
            </motion.ul>
          </div>
        </motion.div>
      </div>
