...
import img from "../../assets/Cryptomaty/signin.webp";
import img2 from "../../assets/Cryptomaty/dashboardw.webp";
import dashboard from "../../assets/Cryptomaty/backtestw.webp";
import strategy from "../../assets/Cryptomaty/brokerw.webp";
import report from "../../assets/Cryptomaty/report.webp";
import point from "../../assets/Cryptomaty/points.webp";

export default function ScriptEditorSection() {
  const images = useMemo(
    () => [img, img2, dashboard, strategy, report, point], // ✅ now 6 images
    []
  );
