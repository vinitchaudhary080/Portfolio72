...
export default function VennUxStrategy() {
  ...
  const playedOnceRef = useRef(false); // ensure it only runs once

  // Trigger ONCE when section is mostly in view
  useEffect(() => {
        ...
        >
          <div className="px-8 md:px-10 max-w-[420px] relative flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Beginners struggled with jargon-heavy UIs.</li>
              <li>Too many steps to place a trade.</li>
              <li>Experienced traders wanted speed + trust.</li>
            </motion.ul>
          </div>
        </motion.div>

        {/* Technical Capabilities (RIGHT) */}
        <motion.div
          custom="right"
          variants={circleVariants}
          initial="stacked"
        ...
        >
          <div className="px-8 md:px-10 max-w-[440px] relative flex flex-col items-center justify-center">
            ...
            <motion.ul
              ...
              className="list-disc pl-5 text-xs md:text-sm text-[#2B2B2B]/85 text-left mt-4 space-y-2"
            >
              <li>Crypto Exchange APIs for live prices and order books.</li>
              <li>Secure wallet integration (cold/hot wallet system).</li>
              <li>Real-time order matching engine with minimal latency.</li>
              <li>Portfolio analytics with charts &amp; history.</li>
              <li>KYC/AML compliance flow embedded in onboarding.</li>
            </motion.ul>
          </div>
        </motion.div>
      </div>
